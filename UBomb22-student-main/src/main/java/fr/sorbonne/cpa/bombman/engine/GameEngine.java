...
import fr.sorbonne.cpa.bombman.audio.AudioPlayer;
...
import fr.sorbonne.cpa.bombman.view.*;
...
/**
 * The {@code GameEngine} class represents the central mechanism of a game handling the overall
 * gameplay, interactions, and dynamics of a grid-based game. This class manages game state updates,
 * rendering, player input, and transitions between game states.
 *
 * It integrates multiple components like player management, sprite handling, and collision detection,
 * and also interacts with the audio system to provide an immersive gaming experience.
 *
...
public final class GameEngine {
    ...
    /**
     * Initializes a new game engine with specified game settings and stage.
     * It sets up the game environment, initializes timers for game mechanics like monsters and bomb explosions,
     * and optionally starts background music if the setting is enabled.
     *
     * @param game The main game logic handler, providing access to configuration and state.
     * @param stage The primary stage of the application where the game will be rendered.
     * @param currentLevel The starting level of the game.
     * @param modeScore Indicates whether the game is in score mode.
     * @param mode2Players Indicates whether the game is in two-player mode.
     * @param stairsBackground Indicates whether to play the background music.
     */
    ...
    /**
     * Processes all player inputs, handling game control actions such as movement and bomb placement.
     * This method should be called every frame to ensure responsive game interactions.
     *
    ...
    /**
     * Updates the game state, including player positions, monster movements, and interactions.
     * This method handles all logic for game state changes that occur over time without direct player interaction.
     *
     * @param now The timestamp of the current frame given in nanoseconds.
     */
    ...
    /**
     * Manages cleanup of sprites that should no longer be displayed. This method is responsible
     * for removing any sprites from the rendering layer that have been marked for deletion, ensuring
     * that the game's visual elements are up-to-date.
     */
    ...
    /**
     * Renders all sprites and UI components to the stage. This method should be called
     * after game state updates to reflect changes in the graphical output.
     */
    private void render() {
